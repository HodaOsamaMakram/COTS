...
#define UBRRH 			*((volatile u8*)0x40)		/*USART Baud Rate Rigister High*/
#define UBRRH_URSEL		7							/*Rigister Select*/

#define UBRRL 			*((volatile u8*)0x29)		/*USART Baud Rate Rigister Low*/

#define UDR				*((volatile u8*)0x2c)		/*USART DATA Register*/

#define	UCSRA			*((volatile u8*)0x2b)		/*USART Control and Status Rigister A*/
#define	UCSRA_RXC		7							/*Receive complete flag*/
#define	UCSRA_TXC		6							/*Transmit complete flag*/
#define	UCSRA_UDRE		5							/*USART Data Register Ù�Empty(The Transmit Data Register is empty)*/
#define	UCSRA_FE		4							/*Fram Error (in The Receive Buffer)*/
...
#define	UCSRB			*((volatile u8*)0x2a)		/*USART Control and Status Rigister B*/
#define	UCSRB_RXCIE		7							/*RX Complate interrupt enable*/
#define	UCSRB_TXCIE		6							/*TX Complate interrupt enable*/
...
#define	UCSRC			*((volatile u8*)0x40)		/*USART Control and Status Rigister C*/
